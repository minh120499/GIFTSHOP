...
function searchCustomer(){
    ...
    if(selectValue ==""){
        document.getElementById('searchErr').innerHTML = " Vui lòng chọn mục tìm kiếm";
        return false;
    ...
    axios.get('http://localhost/BE/Admin/GetUsers.php')
    .then((e) => e.data)
    .then((e) => {
        var html1 = "";
        let STT = [];
        ...
        for(let i=0 ; i<e.length ; i++){
            if(selectValue === 'name' && (e[i].firstname + " " + e[i].lastname).toLowerCase().includes(inputCustomer.toLowerCase()) === true){
                STT.push(i+1);
            ...
            else if(selectValue === 'address' && (e[i].address).toLowerCase().includes(inputCustomer.toLowerCase()) === true){
                STT.push(i+1);
                firstName.push(e[i].firstname);
                lastName.push(e[i].lastname);
                address.push(e[i].address);
            ...
            else if(selectValue === 'phone' && (e[i].phone).toLowerCase().includes(inputCustomer.toLowerCase()) === true){
                STT.push(i+1);
                firstName.push(e[i].firstname);
                lastName.push(e[i].lastname);
                address.push(e[i].address);
                ...
                document.getElementById('searchErr').innerHTML = 'Vui lòng chọn mục cần tìm';
            }else {
        ...
        // đổ dữ liệu ra
        document.getElementById("customer_Management_content_table").innerHTML = html1;
        ...
        setTimeout(() => {
            ...
            a.forEach(item => {
                item.onclick = ()=>{
                                ...
                                <div class="col-8 customer_Information_title">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span>${e[x-1].firstname + " " + e[x-1].lastname}</span>
                                        </li>
                                        <li>
                                            <div class="customer_Information_f">
                                                <span>Birthday : </span>
                    ...
                    document.querySelector('.Information_Customer').innerHTML = htmlCustomer_Information1;
                    $('.customer_Management_container').hide();
                    $('.customer_Information').show();  
                    document.querySelector('.customer_Information_comback').addEventListener('click',function(){
...
function renderContentCustomer(){
    ...
    .then((e) => {
        ...
        // đổ dữ liệu ra
        document.getElementById("customer_Management_content_table").innerHTML = html;
        ...
        setTimeout(() => {
            ...
            a.forEach(item => {
                item.onclick = ()=>{
                                ...
                                <div class="col-8 customer_Information_title">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span>${e[i].firstname + " " + e[i].lastname}</span>
                                        </li>
                                        <li>
                                            <div class="customer_Information_f">
                                                <span>Birthday : </span>
                    ...
                    document.querySelector('.Information_Customer').innerHTML = htmlCustomer_Information;
                    $('.customer_Management_container').hide();
                    $('.customer_Information').show();  
                    document.querySelector('.customer_Information_comback').addEventListener('click',function(){
                        $('.customer_Management_container').show();
...
function SearchProduct(){
    ...
    if(selectproductChoose == ""){
        document.querySelector('.searchProductErr').innerHTML = "Vui lòng chọn mục cần tìm";
        return false;
    }else if(inputProduct == ""){
        document.querySelector('.searchProductErr').innerHTML = "Vui lòng nhập nội dung cần tìm";
        return false;
    }else{
    ...
    .then((e)=>{
        ...
        for(let i = 0 ; i<e.length ; i++){
            if(selectproductChoose === 'name' && (e[i].name).toLowerCase().includes(inputProduct.toLowerCase()) === true){
            ...
            }else if(selectproductChoose === 'price' && e[i].price == inputProduct){
                productid.push(e[i].id);
                productImg.push(e[i].src);
                productname.push(e[i].name);
                productdetaile.push(e[i].detail);
        ...
        document.querySelector('.product_Management_content_container').innerHTML = html2;
        ...
        function showchoosepage(x){
            ...
            var pagingFirstActive = document.querySelector('.product_Management_content_paging span:first-child');
            for(let i=0 ; i<paging; i++){
                html_product_paging +=`<span>${i+1}</span>`;
            }
            document.querySelector('.product_Management_content_paging').innerHTML = html_product_paging;
            ...
            setTimeout(()=>{
                ...
                a.forEach(item => {
                    item.onclick = ()=>{
                        ...
                        document.querySelector('.product_Detail').innerHTML = product_Detail_content;
                        $('.product_Management_container').hide();
                        $('.product_Detail').show();  
                        document.querySelector('.product_Detail_comeback button').addEventListener('click',function(){
        ...
        function chossepage(){
            var product_paging = document.querySelectorAll('.product_Management_content_paging span');
...
function renderProductManagement(){
    ...
    .then((e)=>{
        ...
        document.querySelector('.product_Management_content_container').innerHTML = html_product;
        ...
        function showchoosepage(x){
            ...
            document.querySelector('.product_Management_content_paging').innerHTML = html_product_paging;
            document.querySelector('.product_Management_content_paging span:first-child').classList.add('paging_active');
        }
        ...
        document.querySelector('.Button_show').addEventListener('click',function(){
            var html_product = "";
            var a = [];
            ...
            for(let i=0; i<e.length ; i++){
                ...
                }else if(e[i].anniversary.includes(selectProductBrandText) == true){
                    a.push(e[i].id);
                    html_product += `<div class="product_Management_content_item row">
                        <div class="product_Management_content_item_img col-2">
                            <img src="${e[i].src}" alt="">
...
function SaveInforProduct(){
    ...
    var ProductsSrc = '';
    var product_price_now = document.getElementById('product_price_now').innerHTML;
    var ProductsAniversary = document.getElementById('ProductsAniversary').innerHTML;
    ...
    if(_.isEmpty(imagefile)){
        ...
        ProductsSrc = "http://localhost/img/giftshop/"+ProductsAniversary +"/"+ProductsName+".jpg"
    }
    ...
    if(ProductsName && ProductsDetail && ProductsPrice){
        if(ProductsSrc ==""){
            ...
            axios.post('http://localhost/BE/Admin/UpdateProduct.php',dataUpdate)
            .then(e => {
                console.log(e.data)
            })
        }else{
...
function renderBills(){ 
    ...
    .then((e)=>{
        ...
        document.querySelector('.bill_Management_container_content_container').innerHTML = htmlBill;
...
function rederApiAddProductSelect(){
    ...
    .then((e) => {
        ...
        document.getElementById('product_type').innerHTML = htmlSelectType0 + htmlSelectType;
    });
    ...
    .then((e) => {
        ...
        document.getElementById('product_brand').innerHTML = htmlSelectBrand0 + htmlSelectBrand;
    });
}
...
function rederApiAddProductSelect2(){
    ...
    .then((e) => {
        ...
        document.getElementById('product_type2').innerHTML = htmlSelectType0 + htmlSelectType;
    });
    ...
    .then((e) => {
        ...
        document.getElementById('product_brand2').innerHTML = htmlSelectBrand0 + htmlSelectBrand;
    });
}
...
function addProduct(){
    ...
    if(_.isEmpty(imagefile)){
        ...
        imagefile = "http://localhost/img/giftshop/"+selectProductTypeText+"/"+product_name+'.jpg';
    ...
    var today = '';
    if((d.getMonth()+1)<10){
        today = d.getDate() + '/' + '0'+(d.getMonth()+1) + '/' + d.getFullYear();
    }else{
        today= d.getDate() + '/' + (d.getMonth()+1) + '/' + d.getFullYear();
    }

    // Điều kiện để có thể nhận các sản phẩm
    if(product_name && product_description && product_price && imagefile && selectProductBrandText && selectProductTypeText){
        let arr = {
            name:product_name,
            price:product_price,
        ...
        axios.post('http://localhost/BE/Admin/AddProduct.php',data)
        .then(e => {
            console.log(e.data);
        })
    }
