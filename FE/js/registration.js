...
function SubmitRegistration(){
    ...
    if(_.isEmpty(firstName)){
        firstName = '';
        document.getElementById('firstNameError').innerHTML = star+"please enter firstName";
    }else{
    ...
    if(_.isEmpty(lastName)){
        lastName = '';
        document.getElementById('lastNameError').innerHTML = star+"please enter lastName"
    }else{
    ...
    if(_.isEmpty(address)){
        address = '';
        document.getElementById('addressError').innerHTML = star+"please enter address"
    }else{
    ...
    if(_.isEmpty(birthday)){
        birthday = '';
        document.getElementById('birthdayError').innerHTML = star+"Please select a date of birth";
    }else{
    ...
    if(_.isEmpty(email)){
        email = '';
        document.getElementById('emailError').innerHTML = star+"please enter email";
    ...
    for(let i=0 ; i<mailCompar.length ; i++){
        if(String(mailCompar[i]) == email){
            email = '';
            document.getElementById('emailError').innerHTML = star+"mail already exists";
        }
    }
    ...
    if(_.isEmpty(phone)){
        phone = '';
        document.getElementById('phoneError').innerHTML = star+"please enter Phone";
    } else if(phone.trim().length < 10 && phone.trim().length > 11 && !phoneIsValid(phone)){
        phone = '';
        document.getElementById('phoneError').innerHTML = star+"phone number is not correct"; 
    } else{
    ...
    for(let i=0 ; i<phoneCompar.length ; i++){
        if(String(phoneCompar[i]) == phone){
            phone = '';
            document.getElementById('phoneError').innerHTML = star+"phone number already exists";
        }
    }
    ...
    if(_.isEmpty(password)){
        password = '';
        document.getElementById('passwordError').innerHTML = star+"please enter password";
    }else if(password.trim().length<8){
        password = '';
        document.getElementById('passwordError').innerHTML = star+"Minimum of 8 characters";
    }else if(password.match(lowerCaseLetters) == null){
        password = '';
        document.getElementById('passwordError').innerHTML = star+"at least 1 lowercase letter";
    }else if(password.match(upperCaseLetters) == null){
        password = '';
        document.getElementById('passwordError').innerHTML = star+"at least 1 uppercase letter";
    }else if(password.match(numbers) == null){
        password = '';
        document.getElementById('passwordError').innerHTML = star+"at least 1 digit";
    }else{
    ...
    if(firstName && lastName && address && email && phone && password && birthday){
        console.log("đã đủ");
        // console.log(avatar);
        ...
        CreateAPI(user);    // đẩy lại lên API
