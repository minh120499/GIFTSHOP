export function compare() {
  ...
  // Serach suggest
  document.querySelector('.button-compare-left').onclick = function searchForCompareLeft() {
  ...
  document.querySelector('.button-compare-right').onclick = function searchForCompareRight() {
  ...
  // Onkeyup
  document.querySelector('.product-compare-right').onkeyup = function getSearchValueRight(e) {
    let data = document.querySelector('.product-compare-right').value
    const result = productList.filter(item => item.name.toLowerCase().includes(data.toLowerCase()));
  ...
  document.querySelector('.product-compare-left').onkeyup = function getSearchValueLeft() {
    let data = document.querySelector('.product-compare-left').value
    const result = productList.filter(item => item.name.toLowerCase().includes(data.toLowerCase()));
  ...
  // Show list suggest
  document.querySelector('.product-compare-left').onclick = function showSuggetsLeft() {
  ...
  document.querySelector('.product-compare-right').onclick = function showSuggetsRight() {
    productList.forEach(item => {
      let list = document.createElement('div')
      list.addEventListener('click', () => {
        document.querySelector('.product-compare-right').value = list.textContent
